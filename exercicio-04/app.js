...
const my3FavoriteTVShows = ['Breaking Bad', 'Being Human', 'True Detective']
...
/*
  ...
  caracteres? BOOLEAN."
*/
const numberChars = 39
console.log(`"A string que a "typeSentence" armazena tem mais de ${numberChars}  
caracteres? ${typeSentence.length > numberChars}."`)
...
const answer= `Quando executamos alguma operação envolvendo o null, ele é interpretado como Zero, e como o resultado de null+1 é 1, e o 1 é truthy, é interpretado como true`
