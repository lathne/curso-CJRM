...
//   const biggerThan11 = number >= 11
//   const lessThan90 = number <= 90

//   if (biggerThan11 && lessThan90) {
...
//   }
// }
// console.log(`O crazyArray tem ${typeBoolean} booleans, ${typeNumber} numbers, e ${typeString} strings!`)
...
for (let i = 0; i < randomNumbers.length; i++) {
  ...
  const isEvenNumber = numbers % 2 === 0
...
console.log(`Numeros ímpares: ${oddNumbersString}. Numeros pares: ${evenNumbersString}.`)
