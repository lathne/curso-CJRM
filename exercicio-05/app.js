...
//   const template = `"Esta é a ${index}ª vez que esta frase é exibida no console."`
...
// let upperCaseCitties = []
// for (let index = 0; index < cities.length; index++) {
//   upperCaseCitties.push(cities[index].toUpperCase())
// }
// console.log(upperCaseCitties)
...
//   template = template + `<li>${names[i]}</li>`
// }
// console.log(template)
